            ...
            <div className="row w-100 align-items-center">
                ...
                <div className="col-md-3">
                    <div className="d-flex align-items-center mb-2" style={{ justifyContent: 'flex-start' }}>
                        ...
                        <label className="mb-2" htmlFor="fecha-inicio" style={{ fontWeight: 'bold', color: "var(--blue-unl)", marginLeft: '5px' }}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pin-map" viewBox="0 0 16 16" style={{ marginRight: '5px', color: "var(--blue-unl)" }}> 
                ...
                <div className="col-md-3">
                    <div className="d-flex align-items-center mb-2" style={{ justifyContent: 'flex-start' }}>
                        ...
                        <label className="mb-2" htmlFor="fecha-inicio" style={{ fontWeight: 'bold', color: "var(--blue-unl)", marginLeft: '5px' }}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-calendar-check" viewBox="0 0 16 16" style={{ marginRight: '5px', color: "var(--blue-unl)" }}>
